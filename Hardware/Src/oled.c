...
#define OLED_RS_SET()     HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_SET)
#define OLED_RS_CLR()     HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET)
//OLED的显存
//存放格式如下.
//[0]0 1 2 3 ... 127	
//[1]0 1 2 3 ... 127	
...
uint8_t * data = &dat;		  
	...
	HAL_SPI_Transmit(&hspi2,data,1,200); //需根据实际情况修改 
...
{
	HAL_Delay(200);
	oled_showString(0,0,"Hello World!",6,12);
	oled_showNum(0,16,1234567890,10,6,12);
}
